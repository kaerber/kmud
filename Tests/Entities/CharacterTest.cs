...
namespace Kaerber.MUD.Tests.Entities
{
    ...
    public class CharacterTest : BaseEntityTest {
        ...
        public void MobFromTemplate() {
            ...
            var skillDataSword = new SkillData { Balance = 105, Name = "Sword1", Rating = 106 };
            var skillSword = new Skill( skillDataSword ) { Value = 107 };
            template.Skills.Add( "sword", skillSword );
       ...
       [Test]
        ...
        public void EventIsForwardedToSpecialization() {
            ...
            var self = Character.Create( new Character(), mockSpec.Object );
